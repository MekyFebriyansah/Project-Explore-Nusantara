...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/wisataanda.css') }}" />
...
<body>
    ...
    <div id="kotakKontenBlog">
    <div class="gambarBlogAnda">
        <div class="nomorBlogAnda">02</div>
        <div class="fotoBlog">
            <img src="{{ asset('assets/img/wisataanda.png') }}" alt="" style=" border-radius: 0rem 0rem 25rem 0rem;">
        </div>
    ...
    <div class="gambarBlogAnda">
        <div class="nomorBlogAnda">02</div>
        <div class="fotoBlog">
            <img src="{{ asset('assets/img/gambarBlogAnda1.png') }}" alt="" style=" border-radius: 0rem 0rem 25rem 0rem;">
        </div>
        <div class="teksBlogAnda">
            <div class="sedangproses">
                Telah DiPosting
